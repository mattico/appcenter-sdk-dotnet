...
namespace Microsoft.AppCenter.Analytics.Test.Windows
{
    ...
    public class SessionTrackerTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void DisableAutomaticGenerationSession()
        {
            // Mock channel.
            Log actualLog = null;
            ...
            _sessionTracker.DisableAutomaticSessionGeneration(true);
        ...
        public void EnableAutomaticGenerationSession()
        {
            ...
            _sessionTracker.DisableAutomaticSessionGeneration(false);
